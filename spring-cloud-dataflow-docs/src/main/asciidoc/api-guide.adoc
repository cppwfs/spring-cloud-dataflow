...
* <<api-guide-resources-stream-deployment-undeploy>>
* <<api-guide-resources-stream-deployment-undeploy-all>>
* <<api-guide-resources-stream-deployment-update>> (In Skipper mode)
* <<api-guide-resources-stream-deployment-rollback>> (In Skipper mode)
* <<api-guide-resources-stream-deployment-manifest>> (In Skipper mode)
* <<api-guide-resources-stream-deployment-history>> (In Skipper mode)
* <<api-guide-resources-stream-deployment-platform-list>> (In Skipper mode)
...
When using _Spring Cloud Data Flow_ in Skipper mode, you can update deployed
streams, and provide additional deployment properties.

IMPORTANT: In order to use this feature, the Data Flow server must be in <<spring-cloud-dataflow-stream-lifecycle-skipper, Skipper Mode>>
...
The task executions endpoint lets you delete a task execution.
The following topics provide more detail:
