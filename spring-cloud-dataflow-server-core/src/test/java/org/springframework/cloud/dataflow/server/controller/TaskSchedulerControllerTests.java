	...
	public void testCreateScheduleWithSensitiveFields() throws Exception {
		...
		assertEquals(
				"{\"commandlineArguments\":[\"argument1=foo\",\"password=******\",\"--spring.cloud.scheduler.task.launcher.taskName=testDefinition\"],\"taskDefinitionName\":\"testDefinition\","
						+ "\"taskDefinitionProperties\":{\"spring.datasource.username\":null,\"app.testApp.prop2.secret\":\"******\",\"spring.datasource.url\":null,\"spring.datasource.driverClassName\":null,\"deployer.*.prop2.password\":\"******\",\"deployer.*.prop1.secret\":\"******\",\"spring.cloud.task.name\":\"testDefinition\",\"app.testApp.prop1\":\"foo\"},"
