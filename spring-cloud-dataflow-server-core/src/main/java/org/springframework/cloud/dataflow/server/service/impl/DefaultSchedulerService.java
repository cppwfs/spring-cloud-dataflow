...
public class DefaultSchedulerService implements SchedulerService {
	...
	public void schedule(String scheduleName, String taskDefinitionName, Map<String, String> taskDeploymentProperties,
		...
		TaskServiceUtils.updateDataFlowUriIfNeeded(this.dataflowServerUri, appProperties, commandLineArgs);
		...
		revisedCommandLineArgs.add("--taskName=" + taskDefinitionName);
	...
	private Map<String, String> tagAppProperties(String appName, Map<String, String> appProperties) {
		...
		for(String key : appProperties.keySet()) {
			...
			if (!key.startsWith("dataflowServerUri")) {
	...
	protected Resource getTaskLauncherResource() {
		...
		AppRegistration appRegistration = new AppRegistration(this.taskConfigurationProperties.getSchedulerTaskLauncher(), ApplicationType.app, url);
