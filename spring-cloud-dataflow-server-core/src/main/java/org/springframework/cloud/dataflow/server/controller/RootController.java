...
public class RootController {
	...
	public RootResource info() {
		...
		if (featuresProperties.isTasksEnabled()) {
			...
			root.add(WebMvcLinkBuilder.linkTo(WebMvcLinkBuilder.methodOn(TaskPlatformController.class)
					.listLaunchersWithScheduler(null,null)).withRel("tasks/platforms/scheduler"));
